...
class CreateBatchInformationStorageTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('batch_information_storages', function (Blueprint $table) {
    ...
    {
        //Schema::disableForeignKeyConstraints();                             
        Schema::dropIfExists('batch_information_storages');
    }
}
